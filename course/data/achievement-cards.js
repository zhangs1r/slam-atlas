  ...
  cards: [
    ...
    },
    {
      ...
      thumb_b64:
        ...
        "<stop offset='0%' stop-color='%231b3a2f'/><stop offset='55%' stop-color='%2324503f'/><stop offset='100%' stop-color='%230f2b22'/>" +
        "</linearGradient>" +
        "<radialGradient id='glowd' cx='0.5' cy='0.28' r='0.72'>" +
        "<stop offset='0%' stop-color='%235fd39a' stop-opacity='0.42'/><stop offset='100%' stop-color='%235fd39a' stop-opacity='0'/>" +
        "</radialGradient>" +
        "</defs>" +
        "<rect width='400' height='300' rx='18' fill='url(%23bgd)'/>" +
        "<rect width='400' height='300' rx='18' fill='url(%23glowd)'/>" +
        "<circle cx='200' cy='78' r='58' fill='none' stroke='%235fd39a' stroke-opacity='0.30' stroke-width='1.2'/>" +
        "<circle cx='200' cy='78' r='40' fill='none' stroke='%235fd39a' stroke-opacity='0.45' stroke-width='1.2'/>" +
        "<circle cx='200' cy='78' r='22' fill='none' stroke='%235fd39a' stroke-opacity='0.62' stroke-width='1.2'/>" +
        "<rect x='172' y='70' width='56' height='16' rx='8' fill='%238ee8b8'/>" +
        "<rect x='188' y='56' width='24' height='16' rx='4' fill='%23d8fff0'/>" +
        "<line x1='200' y1='78' x2='284' y2='150' stroke='%235fd39a' stroke-width='1.6' stroke-opacity='0.62'/>" +
        "<line x1='200' y1='78' x2='116' y2='150' stroke='%235fd39a' stroke-width='1.6' stroke-opacity='0.62'/>" +
        "<circle cx='284' cy='150' r='3.6' fill='%23bff5d8'/><circle cx='116' cy='150' r='3.6' fill='%23bff5d8'/>" +
        "<circle cx='252' cy='176' r='3' fill='%238ee8b8'/><circle cx='148' cy='176' r='3' fill='%238ee8b8'/>" +
        "<text x='200' y='205' font-size='30' text-anchor='middle' fill='%23ffffff' font-family='Helvetica, Arial, sans-serif'>📡</text>" +
        "<text x='200' y='242' font-size='27' font-weight='700' text-anchor='middle' fill='%23ffffff' font-family='Helvetica, Arial, sans-serif'>激光雷达手</text>" +
    ...
    },
    {
      ...
      thumb_b64:
        ...
        "<stop offset='0%' stop-color='%2310333d'/>" +
        "<stop offset='58%' stop-color='%2320596a'/>" +
        "<stop offset='100%' stop-color='%230c262e'/>" +
        "</linearGradient>" +
        ...
        "</radialGradient>" +
        "</defs>" +
        "<rect width='400' height='300' fill='url(%23bge)'/>" +
        "<rect width='400' height='300' fill='url(%23glowe)'/>" +
        "<g fill='none' stroke-width='3'>" +
        "<circle cx='152' cy='100' r='48' stroke='%237fd4e4' stroke-opacity='0.9'/>" +
        "<circle cx='248' cy='100' r='48' stroke='%239db8ee' stroke-opacity='0.9'/>" +
        "<circle cx='200' cy='156' r='48' stroke='%23c0a6e8' stroke-opacity='0.9'/>" +
        "</g>" +
        "<g stroke-width='1.4' stroke-opacity='0.4' fill='none'>" +
        "<line x1='200' y1='119' x2='152' y2='100' stroke='%237fd4e4'/>" +
        "<line x1='200' y1='119' x2='248' y2='100' stroke='%239db8ee'/>" +
        "<line x1='200' y1='119' x2='200' y2='156' stroke='%23c0a6e8'/>" +
        "</g>" +
        "<circle cx='200' cy='119' r='8' fill='%23eafbff'/>" +
        "<circle cx='200' cy='119' r='16' fill='none' stroke='%23eafbff' stroke-opacity='0.4' stroke-width='1.5'/>" +
        "<g fill='%23eafbff'>" +
        "<circle cx='152' cy='100' r='3.6'/>" +
        "<circle cx='248' cy='100' r='3.6'/>" +
        "<circle cx='200' cy='156' r='3.6'/>" +
        "</g>" +
        "<text x='88' y='104' font-size='13' text-anchor='middle' fill='%239fe4ef' font-family='Helvetica, Arial, sans-serif'>激光</text>" +
        "<text x='312' y='104' font-size='13' text-anchor='middle' fill='%23b6caf5' font-family='Helvetica, Arial, sans-serif'>视觉</text>" +
        "<text x='200' y='226' font-size='13' text-anchor='middle' fill='%23d2bdf0' font-family='Helvetica, Arial, sans-serif'>IMU</text>" +
        "<text x='200' y='258' font-size='19' font-weight='700' text-anchor='middle' fill='%23eafbff' font-family='Helvetica, Arial, sans-serif'>融合掌舵者</text>" +
    ...
    },
    {
      ...
      thumb_b64:
        ...
        "<stop offset='0%' stop-color='%231d1740'/>" +
        "<stop offset='58%' stop-color='%233f2f78'/>" +
        "<stop offset='100%' stop-color='%23141029'/>" +
        "</linearGradient>" +
        ...
        "</radialGradient>" +
        "</defs>" +
        "<rect width='400' height='300' fill='url(%23bgf)'/>" +
        "<rect width='400' height='300' fill='url(%23glowf)'/>" +
        "<g stroke-width='2.4'>" +
        "<ellipse cx='176' cy='104' rx='68' ry='38' transform='rotate(-24 176 104)' fill='%23b9a3ff' fill-opacity='0.28' stroke='%23cbb8ff' stroke-opacity='0.85'/>" +
        "<ellipse cx='228' cy='122' rx='60' ry='32' transform='rotate(32 228 122)' fill='%238fd8e8' fill-opacity='0.26' stroke='%23a9e6f2' stroke-opacity='0.85'/>" +
        "<ellipse cx='196' cy='158' rx='54' ry='30' transform='rotate(8 196 158)' fill='%23f0a6d8' fill-opacity='0.24' stroke='%23f7bfe6' stroke-opacity='0.8'/>" +
        "<ellipse cx='250' cy='78' rx='38' ry='22' transform='rotate(-58 250 78)' fill='%23cbb8ff' fill-opacity='0.20' stroke='%23dcd0ff' stroke-opacity='0.7'/>" +
        "</g>" +
        "<g fill='%23f4efff'>" +
        "<circle cx='176' cy='104' r='6.4'/><circle cx='228' cy='122' r='6'/><circle cx='196' cy='158' r='5.6'/><circle cx='250' cy='78' r='4.8'/>" +
        "</g>" +
        "<g fill='%23e8e0ff' fill-opacity='0.5'>" +
...
,
    {
      ...
      thumb_b64:
        ...
        "<stop offset='0%' stop-color='%231b2340'/>" +
        "<stop offset='58%' stop-color='%2333376e'/>" +
        "<stop offset='100%' stop-color='%23141a2e'/>" +
        "</linearGradient>" +
        ...
        "<line x1='97' y1='111' x2='264' y2='111' stroke='%238ee8b8' stroke-width='3'/>" +
        "<line x1='143' y1='108' x2='311' y2='108' stroke='%238ee8b8' stroke-width='3'/>" +
        "<line x1='97' y1='130' x2='264' y2='130' stroke='%23f5cf8a' stroke-width='2.6'/>" +
        ...
        "</g>" +
        "<text x='200' y='252' font-size='27' font-weight='700' text-anchor='middle' fill='%23f2f0ff' font-family='Helvetica, Arial, sans-serif'>关联破解者</text>" +
    ...
    },
    {
      ...
      thumb_b64:
        "data:image/svg+xml;utf8," +
        "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><defs><linearGradient id='bgk' x1='0' y1='0' x2='1' y2='1'><stop offset='0%' stop-color='%230a1712'/><stop offset='58%' stop-color='%231f3a30'/><stop offset='100%' stop-color='%2306110c'/></linearGradient><radialGradient id='glowk' cx='50%' cy='34%' r='62%'><stop offset='0%' stop-color='rgba(232,196,106,0.30)'/><stop offset='100%' stop-color='rgba(232,196,106,0)'/></radialGradient></defs><rect width='400' height='300' fill='url(%23bgk)'/><rect width='400' height='300' fill='url(%23glowk)'/><g><rect x='34' y='40' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/><rect x='34' y='64' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/><rect x='34' y='88' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/><rect x='34' y='112' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/><rect x='34' y='136' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/><rect x='34' y='160' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/><rect x='34' y='184' width='200' height='20' rx='4' fill='rgba(255,255,255,0.11)' stroke='rgba(200,226,212,0.42)' stroke-width='1.4'/></g><g font-family='Helvetica, Arial, sans-serif' font-size='12' fill='rgba(234,246,239,0.92)'><text x='46' y='54'>A</text><text x='46' y='78'>B</text><text x='46' y='102'>C</text><text x='46' y='126'>D</text><text x='46' y='150'>E</text><text x='46' y='174'>F</text><text x='46' y='198'>G</text></g><text x='66' y='54' font-size='11' fill='rgba(234,246,239,0.70)' font-family='Helvetica, Arial, sans-serif'>主干七层</text><g><rect x='22' y='44' width='224' height='13' rx='4' fill='rgba(232,196,106,0.20)' stroke='rgba(232,196,106,0.70)' stroke-width='1.4'/><rect x='22' y='68' width='224' height='13' rx='4' fill='rgba(232,196,106,0.20)' stroke='rgba(232,196,106,0.70)' stroke-width='1.4'/><rect x='22' y='92' width='224' height='13' rx='4' fill='rgba(232,196,106,0.20)' stroke='rgba(232,196,106,0.70)' stroke-width='1.4'/><rect x='22' y='116' width='224' height='13' rx='4' fill='rgba(232,196,106,0.20)' stroke='rgba(232,196,106,0.70)' stroke-width='1.4'/></g><g font-family='Helvetica, Arial, sans-serif' font-size='13' fill='%23e8c46a'><text x='258' y='55'>H</text><text x='258' y='79'>I</text><text x='258' y='103'>J</text><text x='258' y='127'>K</text></g><text x='276' y='55' font-size='10' fill='rgba(240,248,243,0.62)' font-family='Helvetica, Arial, sans-serif'>支线</text><text x='276' y='79' font-size='10' fill='rgba(240,248,243,0.62)' font-family='Helvetica, Arial, sans-serif'>尺子</text><text x='276' y='103' font-size='10' fill='rgba(240,248,243,0.62)' font-family='Helvetica, Arial, sans-serif'>零件</text><text x='276' y='127' font-size='10' fill='rgba(240,248,243,0.62)' font-family='Helvetica, Arial, sans-serif'>位置</text><text x='200' y='248' font-size='24' font-weight='700' text-anchor='middle' fill='%23f4faf6' font-family='Helvetica, Arial, sans-serif'>全景结业者</text><text x='200' y='274' font-size='13' text-anchor='middle' fill='rgba(240,248,243,0.74)' font-family='Helvetica, Arial, sans-serif'>十一季 · 205 节课 · A–K 结业</text></svg>",
      card_file: "reference/成就卡-第十一季.html"
    }
  ]
};
