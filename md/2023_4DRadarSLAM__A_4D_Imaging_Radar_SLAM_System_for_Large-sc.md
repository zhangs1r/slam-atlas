...
![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/88e2734349d05cbd53e5f592728fa7b3e9512837f8cae6e285243b69845a57bc.jpg)

(a) Two platforms (handcart, car)  
![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/6c99db7bd4b50260380f52b7cba6f59cad63ea61864bc448fe609b450eaa18f9.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/702fc9257a8bbc4ac70fcbc459ddedf8e1380b469b957e8d79aa22f171baa33d.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/fa4e0c395505a20c2429956df01eb01ce52adc493c9f8e14928ce8590329ed3d.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/0121e6375cfdb2dcd25d38531e76ae859f52c5119ef39ab7da311f70443a6fc4.jpg)  
(b) In a garden (339m)  
...
![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/71ebb918073fe77526f70122c085e6fb7abb6c338f43b031ca58a53ce1bdd0c4.jpg)  
...
2) Scan-to-Scan Matching: In this step, the input is the last key frame and a new frame $\mathcal { F } _ { k }$ and $\mathcal { P } _ { t }$ . The objective is to find the transformation $\mathbf { T } _ { t } ^ { k }$ (from t to k). Since the point cloud of 4D radar is noisier, it is not straightforward to extract geometric features (such as edges and planes). While we find that GICP can output acceptable result compared with ICP and NDT. The initial transformation is set to the last transformation $\mathbf { T } _ { t - 1 } ^ { k }$

We propose a new algorithm called Adaptive Probability Distribution-GICP (APDGICP), which takes into account the spatial probability distribution of each point in GICP. According to the radar’s manual, the uncertainty of a point’s range measurement is given by $\sigma _ { r } = 0 . 0 0 2 1 5 r$ , where r and $\sigma _ { r }$ are the measured range and its uncertainty, respectively. The azimuth and elevation angle accuracy is $0 . 5 ^ { \circ }$ and $1 . 0 ^ { \circ }$ respectively, which lead to uncertainties in the azimuth and elevation directions in spherical coordinates, approximated by $\sigma _ { a } \approx s i n ( 0 . 5 ^ { \circ } ) r$ and $\sigma _ { e } \approx s i n ( 1 . 0 ^ { \circ } ) r$ . The resulting probability distribution is shown in Fig. 3, resembling an ellipsoid (orange) with one axis pointing to the origin and the three half-axes having lengths of $\sigma _ { r }$ (range), $\sigma _ { a }$ (azimuth), and $\sigma _ { e }$ (elevation).

The covariance matrix of the point in the local frame (Fig. 3 purple) is $S = \left\lceil \begin{array} { c c c } { { \sigma _ { r } } } & { { 0 } } & { { \mathit { \widehat { \sigma } } } } \\ { { 0 } } & { { \sigma _ { a } } } & { { 0 } } \\ { { 0 } } & { { 0 } } & { { \sigma _ { e } } } \end{array} \right\rceil$ . We need to transform it to the radar frame (Fig. 3 black). According to multivariate normal distribution and linear transformation, a three-dimensional linear transform matrix $A \ : = \ : R S$ can be built. Here, A is the covariance in radar frame, R is the rotation matrix from local to radar frame, $R \ =$ $\left[ \begin{array} { c c c } { { \cos \theta _ { a } \cos \theta _ { e } } } & { { \sin \theta _ { a } } } & { { - \cos \theta _ { a } \sin \theta _ { e } } } \\ { { - \sin \theta _ { a } \cos \theta _ { e } } } & { { \cos \theta _ { a } } } & { { \sin \theta _ { a } \sin \theta _ { e } } } \\ { { \sin \theta _ { e } } } & { { 0 } } & { { \cos \theta _ { e } } } \end{array} \right] ~ , ~ \theta _ { a }$ and $\theta _ { e }$ are the point’s azimuth and elevation angle. Finally, the covariance matrix in radar frame can be calculated as $C _ { p } = A A ^ { T }$ In GICP, the transform matrix T is calculated using

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/b971f87216388f7be7d362e9ac112b66cf9f050048cf54d8581f4ce06e6034ce.jpg)  
Fig. 3: The probability distribution of a point.

Maximum Likelihood Estimation (MLE) by Eq. (1) [14].

$$
\underset { { \bf { T } } } { \arg \operatorname* { m i n } } \sum _ { i } { d _ { i } ^ { ( T ) } } ^ { T } ( C _ { i } ^ { B } + { \bf { T } } C _ { i } ^ { A } { \bf { T } } ^ { T } ) ^ { - 1 } d _ { i } ^ { ( T ) }\tag{1}
$$

where $C _ { i } ^ { A }$ and $C _ { i } ^ { B }$ are covariance matrices associated with the corresponding measured points and $d _ { i } ^ { ( T ) }$ is their distance. In our proposed APDGICP, we derive it as Eq. (2).

$$
\underset { \mathbf { T } } { \arg \operatorname* { m i n } } \sum _ { i } { d _ { i } ^ { ( T ) } } ^ { T } \left[ ( C _ { i } ^ { B } + C _ { p } ) + \mathbf { T } ( C _ { i } ^ { A } + C _ { p } ) \mathbf { T } ^ { T } \right] ^ { - 1 } d _ { i } ^ { ( T ) }\tag{2}
$$

By adding an additional term $C _ { p }$ to the equation, the algorithm considers not only geometric distribution of the neighboring points, but also the spatial variance of each point. The rationale behind this is that points closer to the radar have lower uncertainty and should be given higher weight, vice versa.

3) Key Frame Selection: The first frame is designated as a fixed key frame, while subsequent key frames are determined if it meets any of the following two conditions: $i ) ,$ the translation between the current frame and the last key frame exceeds a threshold $\delta _ { t } ; \mathbf { \Gamma } _ { i i } ) .$ , the rotation between the current frame and the last key frame exceeds a threshold $\delta _ { r }$ . The threshold parameters are set empirically as follows: $\delta _ { t } = 0 . 5 m$ or $2 m , \delta _ { r } = 1 5 ^ { \circ }$

The scan-to-scan matching result between $k ^ { \mathrm { t h } }$ and $k + 1 ^ { \mathrm { t h } }$ key frame is added to the pose graph as $S E ( \mathcal { B } )$ binary edges. The covariance of the edge, denoted as $\Sigma _ { k + 1 } ^ { k }$ , is calculated based on the fitness score of the two key frame clouds.

## D. Loop Detection

In this step, each key frame is compared with the database key frames to determine whether it forms a loop closure.

1) Loop pre-filtering: To avoid searching the entire database for loop detection, loop pre-filtering step is carried out to identify potential loops based on four rules: i) adherence to distance restrictions, meaning that a new loop’s query frame should not be too close to the last loop’s query frame, and a loop’s frames should not be too close; ii) ensuring that a loop’s frames are within a certain radius (spatially near). We adaptively adjust the searching radius, which is proportional to the travel distance between frames, and once a loop is found, the searching radius will decrease accordingly if a candidate loop is close to it; iii) enforcing a threshold of 2m for the altitude difference between a loop’s frames, based on altitude information from the barometer; iv) ensuring that a loop’s frames have a similar yaw angle, with a threshold of $2 0 ^ { \circ }$ found to be suitable for avoiding false positive matching for our radar.
...
Scan context was originally proposed for LiDAR with a $3 6 0 ^ { \circ }$ azimuth FOV. We adapted it to 4D Radar with a narrower 110° azimuth FOV. To do this, we divided the point cloud into 40 rings and 20 sectors, resulting in a unit ring gap of 2m, and a unit sector angle of 5.5°.
...
Fig. 4 illustrates the basic concept. The idea is to compare the transformation from the query frame $j$ to the loop candidate i with the odometry from $j$ to i, as expressed in Eq. (3). $\begin{array} { r } { \frac { 1 } { m } ( \mathbf { \dot { T } } _ { j } ^ { i ( l c ) } ) ^ { - 1 } \mathbf { T } _ { j } ^ { i } } \end{array}$ (odom) If the average accumulated pose error exceeds a translation and rotation threshold $\epsilon _ { t }$ and $\epsilon _ { r } ,$ outlier loops can be rejected, where m is the number of key frames from i to $j .$ In our experiments, we set ϵ = 0.15m and ϵ = 0.05rad (or 2.9°).

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/a6c4651324daa71d472220a7b5e16d44ce436224076beaf9f68640756ae23e82.jpg)  
Fig. 4: Pose graph and loop detection.

$$
\mathbf { T } _ { j } ^ { i ( l c ) } \approx \mathbf { T } _ { j } ^ { i ( o d o m ) }\tag{3}
$$
...
TABLE II. QUANTITATIVE ANALYSIS: TRAJECTORY ERROR RE $( t _ { r e l } , r _ { r e l } )$ AND ATE $( t _ { a b s } ) .$
<table><tr><td></td><td colspan="3">gicp</td><td colspan="3">gicp-lc</td><td colspan="3">apdgicp</td><td colspan="3">apdgicp-lc</td><td colspan="3">apdgicp-gps</td></tr><tr><td>Dataset</td><td> $t _ { r e l }$ </td><td> $r _ { r e l }$ </td><td> $t _ { a b s }$ </td><td> $t _ { r e l }$ </td><td> $r _ { r e l }$ </td><td> $t _ { a b s }$ </td><td> $t _ { r e l }$ </td><td> $r _ { r e l }$ </td><td> $t _ { a b s }$ </td><td> $t _ { r e l }$ </td><td> $r _ { r e l }$ </td><td> $t _ { a b s }$ </td><td> $t _ { r e l }$ </td><td> $r _ { r e l }$ </td><td> $t _ { a b s }$ </td></tr><tr><td></td><td>(%)</td><td>(deg/m)</td><td>(m)</td><td>(%)</td><td>(deg/m)</td><td>(m)</td><td>(%)</td><td>(deg/m)</td><td>(m)</td><td>(%)</td><td>(deg/m)</td><td>(m)</td><td>(%)</td><td>(deg/m)</td><td>(m)</td></tr><tr><td>cp</td><td>4.13</td><td>0.0552</td><td>3.96</td><td>2.79</td><td>0.0511</td><td>2.54</td><td>3.56</td><td>0.0369</td><td>2.61</td><td>3.02</td><td>0.0448</td><td>2.35</td><td></td><td></td><td></td></tr><tr><td>garden</td><td>2.64</td><td>0.0310</td><td>4.53</td><td>2.38</td><td>0.0293</td><td>3.69</td><td>2.69</td><td>0.0350</td><td>4.06</td><td>2.05</td><td>0.0309</td><td>2.41</td><td></td><td></td><td></td></tr><tr><td>nyl</td><td>4.62</td><td>0.0184</td><td>17.42</td><td>3.10</td><td>0.0120</td><td>14.34</td><td>3.55</td><td>0.0171</td><td>21.30</td><td>2.85</td><td>0.0131</td><td>11.37</td><td></td><td></td><td></td></tr><tr><td>loop 1</td><td>4.84</td><td>0.0060</td><td>132.92</td><td>4.12</td><td>0.0065</td><td>68.88</td><td>6.09</td><td>0.0082</td><td>227.54</td><td>5.79</td><td>0.0100</td><td>84.88</td><td>3.00</td><td>0.0057</td><td>5.28</td></tr><tr><td>loop 2</td><td>3.22</td><td>0.0060</td><td>57.29</td><td>3.46</td><td>0.0052</td><td>72.28</td><td>4.09</td><td>0.0097</td><td>59.12</td><td>4.03</td><td>0.0069</td><td>43.67</td><td>3.84</td><td>0.0052</td><td>2.94</td></tr></table>

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/2d9ba851ad3b086700a30e5de52c07cdcfd7771203f267e2111263dca10d388e.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/b8b0695c483295cf306f6ddcf1fa6dabd7f94de7db1466c6ae42d31c86f320bf.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/64baab819ed94625bb4f6ea348f6febc73516e787553f545cac296cafa6b6931.jpg)  
(a) On handcart (low speed), datasets “cp”,“garden”,“nyl”.

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/3de9fbda3f26c79e0c0be98de996304c8f85aab07b1ae38502b323683734cee8.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/620848dfacebac1f10fdb57c294d94fb8d4acc1dbe1e9dd0db10133735c9309e.jpg)  
(b) On car (middle speed), datasets “loop 1”,“loop $2 ^ { \circ } .$

Fig. 5: Compare our estimated trajectory with the ground truth trajectory, under 5 datasets.  
![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/2abcf05b1ed8fe19c1847605e2d3f79337a6af9258606b67f69d96a987c99f8d.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/4ca951752d07c02ab528259d69583e65d01669d58d3ffb12e53f2dc2e243f291.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/0d359bcd6661451c2eed896795a540d243f4c591f7faac6b5f7520a9ca88dd56.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/1c9691f231b91083e9fd151a223bdd3e8f460dfd62fb87db3f1a498db41c09d2.jpg)

![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/78bbf8f7e7ad6b0fee73cfa17e5734086138ab9b66e8c5d36b9e494c6d14d73c.jpg)  
...
$1 ^ { \circ }$ and “loop $2 ^ { \circ }$ . More points are distributed further apart (as shown in Fig. 8) in larger datasets, which receive lower weights and thus provide less valid points for registration. In comparison to GICP, the number of points decreases by 2 − 3 times. However, for smaller environments (“cp”, “garden”), APDGICP is better, while for the middle environment (”nyl”), APDGICP performs slightly better.

To facilitate evaluation, the numerical values of RE and ATE are listed in Tab. II. Here, $t _ { r e l }$ and $r _ { r e l }$ represent the translation and rotation errors for RE, while $t _ { a b s }$ represents ATE. We observed that: i) For the frontend (gicp, apdgicp) have an overall translation error of $\begin{array} { r l r } { t _ { r e l } } & { { } \in } & { [ 2 . 6 4 \% , 6 . 0 9 \% ] } \end{array}$ and rotation error of $r _ { r e l } \in$ [0.0060, 0.0552]deg/m. ii) The loop closure improves the translation error to $t _ { r e l } \in [ 2 . 0 5 \% , 5 . 7 9 \% ]$ and rotation error to $r _ { r e l } \in [ 0 . 0 0 5 2 , 0 . 0 5 1 1 ] d e g / m$ . The ATE also improves from 2.61m to 2.35m for $ { \mathrm { ^ { 6 } c p } } ^ {  { \mathrm { , 5 } } }$ , from 4.06m to 2.41m for “garden” and from 21.30m to 11.37m for “nyl”. iii) The back-end optimization using GPS significantly improves the ATE, reducing it from 68.88m to 5.28m for “loop 1” and from 43.67m to 2.94m for “loop 2”.
...
![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/e5fa874c7e3c8a0a7182339b62cd0832255db041c54f6242aaa34894ae5cd3eb.jpg)  
...
![](images/2023_4DRadarSLAM__A_4D_Imaging_Radar_SLAM_System_for_Large-sc/3d496f1d3c77f923451fe314b89cf559562807dc8532cbb8d69d353d4dcb3719.jpg)  
...
<table><tr><td rowspan="2">Sengs</td><td rowspan="2">Dataset Length(m) Key-frame distance(m) No. of</td><td rowspan="2">cp 246</td><td rowspan="2">garden 339</td><td>nyl 1017</td><td>loop 1 4795</td><td>loop 2 4233</td></tr><tr><td>0.5 0.5</td><td>0.5</td><td>2.0</td><td>2.0</td></tr><tr><td rowspan="2">Fron-end</td><td>keyframes Ego-velocity</td><td>437</td><td>623</td><td>1788</td><td>2152</td><td>1803</td></tr><tr><td>estimation Scan-to-Scan</td><td>1.1</td><td>1.1</td><td>1.1</td><td>0.9</td><td>0.8</td></tr><tr><td rowspan="3"></td><td>matching</td><td>2.9</td><td>2.8</td><td>3.1</td><td>2.8</td><td>3.0</td></tr><tr><td>Sub-total Loop</td><td>4.0</td><td>3.9</td><td>4.2</td><td>3.7</td><td>3.8</td></tr><tr><td>pre-filtering Scan</td><td>11.3</td><td>14.5</td><td>28.8</td><td>1.3</td><td>2.2</td></tr><tr><td>Loeceton Dton</td><td>context Odometry</td><td>119.9</td><td>107.4</td><td>114.0</td><td>43.2</td><td>27.4</td></tr><tr><td></td><td>check Sub-total</td><td>0.05 131.25</td><td>0.06 121.96</td><td>0.14 142.94</td><td>0.02 44.52</td><td>0.02</td></tr><tr><td colspan="2">Bac- ed g2o</td><td>1049</td><td>897</td><td>2120</td><td>285</td><td>29.62 592</td></tr></table>
...
[35] J. Lin, C. Zheng, W. Xu, and F. Zhang, “R<sup>2</sup>LIVE: A Robust, Real-Time, LiDAR-Inertial-Visual Tightly-Coupled State Estimator and Mapping,” IEEE Robotics and Automation Letters, vol. 6, no. 4, pp. 7469–7476, 2021.
