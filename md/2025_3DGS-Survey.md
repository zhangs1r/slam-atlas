...
Traditional point-based rendering methods primarily focus on generating high-quality rendered outputs using a specified geometry. However, the advent of new implicit representation techniques has spurred researchers to explore point-based rendering with neural implicit representation. This approach does not depend on a predefined geometry for the purpose of 3D reconstruction. An exemplary work in this field is Neural Radiance Fields (NeRF) [13], which utilizes an implicit density field to model geometry and employs an appearance field to predict view-dependent color $c _ { i } .$ . Point-based rendering is employed to combine the colors of all sample points along a camera ray, resulting in the generation of a pixel color C:

$$
C = \sum _ { i = 1 } ^ { N } c _ { i } \alpha _ { i } T _ { i }\tag{1}
$$

where N represents the number of sample points along a ray. The view-dependent color and opacity value for the i-th point on the ray are denoted as $\begin{array} { r } { \alpha _ { i } = \exp ( - \sum _ { j = 1 } ^ { i - 1 } \sigma _ { j } \delta _ { j } ) } \end{array}$ . Here, $\sigma _ { j }$ refers to the density value of the j-th point. The accumulated transmittance is given by $\begin{array} { r } { T _ { i } = \prod _ { i = 1 } ^ { i - 1 } ( 1 - \alpha _ { j } ) } \end{array}$
...
Gaussian Splatting Radiance Fields: Gaussian Splatting Radiance Field [1] also referred to as 3D Gaussian Splatting, is an explicit radiance field-based scene representation that represents a radiance field using a large number of 3D anisotropic balls, each modeled using a 3D Gaussian distribution (2). More concretely, each anisotropic ball has mean $\mathcal { M } \in \mathbb { R } ^ { 3 }$ , covariance Σ, opacity $\alpha \in \mathbb { R }$ and spherical harmonics parameters $\mathcal { C } \in \mathbb { R } ^ { k }$ (k is the degrees of freedom) for modeling view-dependent color.

For regularizing optimization, the covariance matrix is further decomposed into rotation matrix R and scaling matrix S by (3). These matrices are further represented as quaternions $r \in \mathbb { R } ^ { 4 }$ and scaling factor $s \in \mathbb { R } ^ { 3 }$

$$
G ( X ) = e ^ { - \frac { 1 } { 2 } \mathcal { M } ^ { T } \Sigma ^ { - 1 } \mathcal { M } }\tag{2}
$$

$$
\boldsymbol { \Sigma } = \mathbf { R } \mathbf { S } \mathbf { S } ^ { T } \mathbf { R } ^ { T }\tag{3}
$$
...
$$
C = \sum _ { i \in N _ { \mathrm { c o v } } } c _ { i } \alpha _ { i } \prod _ { j = 1 } ^ { i - 1 } \left( 1 - \alpha _ { j } \right)\tag{4}
$$

where, $N _ { \mathrm { c o v } }$ represents the splats that cover this pixel, $\alpha _ { i }$ represents the opacity of this Gaussian splat multiplied by the density of the projected 2D Gaussian distribution at the location of the pixel, and $c _ { i }$ represents the computed color.
...
<table><tr><td>Dataset</td><td>Year</td><td>Samples</td><td>Camera Views</td><td>Type</td><td>Description</td><td>Task</td><td>#Number</td></tr><tr><td>Mip-NeRF 360 [15]</td><td>CVPR&#x27;22</td><td>9</td><td>360 viewpoint</td><td>Videos</td><td>Outdoor and indoor scene containing a complex central object or area with a detailed background</td><td>Representation &amp; Reconstruction</td><td>49</td></tr><tr><td>Tanks and Temples [16]</td><td>ToG&#x27;17</td><td>14</td><td>263-1107</td><td>Videos</td><td>Ground-truth captured by high quality industrial laser sċanner</td><td>Representation &amp; Reconstruction</td><td>34</td></tr><tr><td>DeepBlending [17]</td><td>TOG&#x27;18</td><td>19</td><td>12-418</td><td>Images</td><td>Images with suicient variety of scene content</td><td>Representation &amp; Reconstruction</td><td>18</td></tr><tr><td>Plenoptic Video [18]</td><td>CVPR&#x27;22</td><td>6</td><td>21</td><td>Videos</td><td>Captured daily events with chalenging scene motions</td><td>Representation &amp; Reconstruction</td><td>3</td></tr><tr><td>D-Nerf [19]</td><td>CVPR&#x27;21</td><td>8</td><td>360 viewpoint</td><td>Synthetic videos</td><td>Animated objects with complex geometries and non-Lambertian materials</td><td>Representation &amp; Manipulation</td><td>9</td></tr><tr><td>DyNeRF [18]</td><td>CVPR&#x27;22</td><td>6</td><td>20</td><td>Videos</td><td>Time-synchronized and calibrated multi-view</td><td>Representation</td><td>3</td></tr><tr><td>NeRF-LLFF [20]</td><td>SIGGRAPH&#x27;19</td><td>8</td><td>forward-facing views</td><td>images</td><td>videos that covers challenging 4D scenes A subset of Real Iconic</td><td>Representation</td><td>11</td></tr><tr><td>RealEstate10k [21]</td><td>ToG&#x27;18</td><td> $a \mathrm { { b o u t 8 0 k } }$ </td><td></td><td>Videos</td><td>Video clips on YouTube shot from a moving camera</td><td>Reconstruction</td><td></td></tr><tr><td>ACID [22] ShapeNet [23]</td><td>ICCV&#x27;21 2015</td><td>765</td><td></td><td>Videos</td><td>A dataset of aerial landscape videos</td><td>Reconstruction</td><td>321</td></tr><tr><td></td><td></td><td>about 60k</td><td>50</td><td>Synthetic images</td><td>A richly-annotated, large-scale dataset of 3D shapes Dynamic half-body human videos by four</td><td>Reconstruction</td><td></td></tr><tr><td>Tensor4D [24]</td><td>CVPR&#x27;23</td><td>4</td><td>1,4, 12</td><td>Videos</td><td>sparsely positioned, fixed RGB cameras</td><td>Manipulation</td><td>5</td></tr><tr><td>NeRF-DS [19] CoNeRF [25]</td><td>CVPR&#x27;23 CVPR&#x27;22</td><td>77</td><td>2 forward-facing views</td><td>Videos Videos</td><td>Dynamic specular dataset</td><td>Manipulation</td><td>21</td></tr><tr><td></td><td></td><td></td><td></td><td></td><td>Real face scenes 2.6M labeled single and</td><td>Manipulation</td><td></td></tr><tr><td>InterHand2.6M [26]</td><td>ECCV&#x27;20</td><td>36</td><td>80-140</td><td>Videos</td><td>interacting hand frames</td><td>Manipulation</td><td>1</td></tr><tr><td>NVOS [27]</td><td>ICCV&#x27;22</td><td>7</td><td>20-62</td><td>Images</td><td>Real-world front-facing scenes with annotated object masks based on LLFF</td><td>Perception</td><td></td></tr><tr><td>SPIn-NeRF [28] LERF [29]</td><td>CVPR&#x27;23</td><td>11013 18 2</td><td>100</td><td>Images</td><td>Real-world forward-facing scenes with human annotated object masks</td><td>Perception</td><td>2 5</td></tr><tr><td>Replica [30]</td><td>ICCV&#x27;23 arXiv&#x27;19</td><td></td><td></td><td>Videos</td><td>A mixture of in-the-wild and posed long-tail scenes</td><td>Perception</td><td>14</td></tr><tr><td>KITTI [31]</td><td>CVPR&#x27;12</td><td></td><td></td><td>Videos Videos</td><td>Highly photo-realistic 3D indoor scene dataset at room and building scale A city-scale dataset created for autonomous driving research</td><td>Perception Perception</td><td>5</td></tr><tr><td>Objaverse 1.0 [32]</td><td>CVPR&#x27;23</td><td>818k</td><td></td><td>3D objects</td><td>A large dataset of over 800K 3D models with descriptive captions, tags, and animations.</td><td>Generation</td><td>2</td></tr><tr><td>OmniObject3D [33]</td><td>CVPR&#x27;23</td><td>6k</td><td></td><td></td><td>Real-scanned 3D object captured with both 2D and 3D sensors, providing textured meshes,</td><td>Generation &amp; Perception</td><td></td></tr><tr><td></td><td></td><td></td><td></td><td>3D objects</td><td>point clouds, multi-view rendered images, and multiple real-captured videos.</td><td>&amp; Reconstruction</td><td>4</td></tr><tr><td>People-Snapshot [34]</td><td>CVPR&#x27;18</td><td>24</td><td>1</td><td>Videos</td><td>Containing subjects captured